...
public class MatserPool {
     ...
     */
    public MatserPool() throws SQLException, ClassNotFoundException {
    ...
    public Connection createConnection() throws ClassNotFoundException, SQLException {
        ...
        Connection connection = DriverManager.getConnection("jdbc:mysql://120.26.187.19:3307/demo", "root", "123456");
        return connection;
    }
